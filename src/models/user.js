...
class User {
   constructor(name, email, password, avatarURL) {
      ...
      this.avatarURL = avatarURL
         ? avatarURL
         : `https://avatars.dicebear.com/v2/gridy/${new ObjectId()}.svg`;
   }
   ...
   static async initialise() {
      ...
      if (collections.length === 0) {
                  ...
                  $jsonSchema: {
                     ...
                     properties: {
                        ...
                        avatarURL: {
                           bsonType: "string",
                           description:
                              "Must be a string and required for each user"
                        }
                     }
                  }
               }
         ...
         try {
            ...
            throw new Error(
               "Couldn't Create Index on Emails\n Message:",
               e.message
            );
         }
      }
